...
const FeatureExampleModal: React.FC<FeatureExampleModalProps> = ({ isOpen, onClose, feature }) => {
    ...
    switch (feature.title) {
        ...
        return {
          ...
          content: (
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-[#8f4eff] to-[#18e6c1] rounded-2xl p-8 text-white shadow-xl">
      ...
      case 'Real-time Analytics':
        return {
          ...
          content: (
            <div className="space-y-6">
              <div className="bg-[#fafaff] rounded-2xl p-8 border border-[#8f4eff]/20 shadow-xl">
                <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6">Poll: "Best Team Building Activity"</h3>
                
                {/* Vote Counts */}
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-gradient-to-br from-[#8f4eff] to-[#18e6c1] rounded-xl p-4 text-white text-center">
                    <div className="text-3xl font-bold">127</div>
                    <div className="text-sm opacity-90">Total Votes</div>
                  </div>
                  <div className="bg-gradient-to-br from-[#18e6c1] to-[#2ef9d8] rounded-xl p-4 text-white text-center">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="h-4 bg-[#8f4eff]/10 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-[#8f4eff] to-[#18e6c1] rounded-full" style={{ width: '45%' }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-2">
                    ...
                    <div className="h-4 bg-[#8f4eff]/10 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-[#8f4eff] to-[#18e6c1] rounded-full" style={{ width: '32%' }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-2">
                    ...
                    <div className="h-4 bg-[#8f4eff]/10 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-[#8f4eff] to-[#18e6c1] rounded-full" style={{ width: '18%' }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-2">
                    ...
                    <div className="h-4 bg-[#8f4eff]/10 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-[#8f4eff] to-[#18e6c1] rounded-full" style={{ width: '5%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="bg-[#fafaff] rounded-xl p-6 border border-[#8f4eff]/20">
                ...
                <ul className="space-y-2 text-[#4a4a6a]">
                  <li className="flex items-center gap-2">
                    <span className="text-[#18e6c1]">✓</span>
            ...
            <div className="space-y-6">
              <div className="bg-[#fafaff] rounded-2xl p-8 border border-[#8f4eff]/20 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Workspace 1 */}
                  <div className="bg-gradient-to-br from-[#8f4eff] to-[#18e6c1] rounded-xl p-6 text-white">
                  ...
                  {/* Workspace 2 */}
                  <div className="bg-gradient-to-br from-[#18e6c1] to-[#2ef9d8] rounded-xl p-6 text-white">
                    <div className="flex items-center justify-between mb-4">
                  ...
                  {/* Workspace 3 */}
                  <div className="bg-gradient-to-br from-[#ff6363] to-[#ff8a8a] rounded-xl p-6 text-white">
                    <div className="flex items-center justify-between mb-4">
                  ...
                  {/* Workspace 4 */}
                  <div className="bg-gradient-to-br from-[#8f4eff] to-[#ff6363] rounded-xl p-6 text-white">
                    <div className="flex items-center justify-between mb-4">
            ...
            <div className="space-y-6">
              <div className="bg-[#fafaff] rounded-2xl p-8 border border-[#8f4eff]/20 shadow-xl">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-3 rounded-lg border-2 border-[#8f4eff]/20 bg-white text-[#1a1a2e] font-mono text-sm"
                    />
                    <button className="px-6 py-3 bg-gradient-to-r from-[#8f4eff] to-[#18e6c1] text-white rounded-lg font-bold hover:from-[#a366ff] hover:to-[#2ef9d8] transition-all shadow-lg">
                      Copy
                    </button>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <button className="bg-gradient-to-br from-[#8f4eff] to-[#18e6c1] rounded-xl p-6 text-white hover:scale-105 transition-all shadow-lg">
                    <div className="text-4xl mb-3">📊</div>
                    <div className="font-bold">CSV Export</div>
                    <div className="text-sm opacity-90 mt-1">Spreadsheet data</div>
                  </button>
                  <button className="bg-gradient-to-br from-[#18e6c1] to-[#2ef9d8] rounded-xl p-6 text-white hover:scale-105 transition-all shadow-lg">
                    <div className="text-4xl mb-3">📄</div>
                    <div className="font-bold">JSON Export</div>
                    <div className="text-sm opacity-90 mt-1">Raw data format</div>
                  </button>
                  <button className="bg-gradient-to-br from-[#ff6363] to-[#ff8a8a] rounded-xl p-6 text-white hover:scale-105 transition-all shadow-lg">
                ...
                {/* Share Options */}
                <div className="bg-gradient-to-br from-[#8f4eff]/10 to-[#18e6c1]/10 rounded-xl p-6 border border-[#8f4eff]/20">
                  <h4 className="font-bold text-[#1a1a2e] mb-4">Share via:</h4>
                  <div className="flex flex-wrap gap-3">
                    <button className="px-4 py-2 bg-white rounded-lg border border-[#8f4eff]/20 hover:bg-[#f0f0ff] transition-all text-[#1a1a2e] font-semibold">
                      📧 Email
                    </button>
                    <button className="px-4 py-2 bg-white rounded-lg border border-[#8f4eff]/20 hover:bg-[#f0f0ff] transition-all text-[#1a1a2e] font-semibold">
                      💬 Slack
  ...
  return (
    ...
    >
      <div
        className="bg-[#fafaff] rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-[#8f4eff]/20"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Modal Header */}
        <div className="sticky top-0 bg-gradient-to-r from-[#8f4eff] to-[#18e6c1] text-white p-6 rounded-t-2xl flex items-center justify-between z-10">
        ...
        {/* Modal Footer */}
        <div className="sticky bottom-0 bg-[#fafaff] border-t border-[#8f4eff]/20 p-6 rounded-b-2xl flex justify-end">
          <button
            onClick={onClose}
            className="px-8 py-3 bg-gradient-to-r from-[#8f4eff] to-[#18e6c1] text-white rounded-xl font-bold hover:from-[#a366ff] hover:to-[#2ef9d8] transition-all shadow-lg"
          >
            Got it!
          </button>
        </div>
